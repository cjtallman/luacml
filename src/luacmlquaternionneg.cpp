...
///
/// @file   luacmlquaternionneg.cpp
/// @date   09/15/2016
/// @author ctallman
///
/// @brief  Lua CML quaternion_n.
///
////////////////////////////////////////////////////////////////////////////////
...
namespace QuatNeg {
const char* UDATA_TYPE_NAME = "quat_n";
...
int New(lua_State* L)
{
    ...
    case 1:
        ...
        {
            const int result = QuatNeg::GetNumbersFromUserdata(L, 1, temp.data(), NUM_ELEMENTS) ||
                               Vector4::GetNumbersFromUserdata(L, 1, temp.data(), NUM_ELEMENTS) ||
                               QuatPos::GetNumbersFromUserdata(L, 1, temp.data(), NUM_ELEMENTS);
    ...
    case 2:
        // cml.quat_n(1.0, cml.vector3(0,0,0)) --> quat_n:<0,0,0,1>
        ...
        // cml.quat_n(cml.vector3(0,0,0), 1.0) --> quat_n:<0,0,0,1>
        ...
        // cml.quat_n(1.0, {0,0,0}) --> quat_n:<0,0,0,1>
        ...
        // cml.quat_n({0,0,0}, 1.0) --> quat_n:<0,0,0,1>
    ...
    case 4:
        // cml.quat_n(1.0, 2.0, 3.0, 4.0) --> quat_n:<1,2,3,4>
