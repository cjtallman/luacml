...
describe("vector2", function()
    ...
    describe("operator", function()
        local A = constructor(1,2)
        local B = constructor(2,3)
        ...
        it("==", function()
            assert.is_false(A == B)
            assert.is_true(A == A)
            assert.is_true(A == constructor(1,2))
        end)

        it("~=", function()
            assert.is_true(A ~= B)
            assert.is_false(A ~= A)
            assert.is_false(A ~= constructor(1,2))
        end)
    end)
end)
