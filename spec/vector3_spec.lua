...
describe("vector3", function()
    ...
    describe("constructor", function()
        it("default", function()
            assert.matches("<0,0,0>", cml.vector3())
        end)

        it("with 1 number", function()
            assert.matches("<0,0,0>", cml.vector3(0))
            assert.matches("<123,0,0>", cml.vector3(123))
            assert.matches("<1.23,0,0>", cml.vector3(1.23))
            assert.matches("<"..-math.pi..",0,0>", cml.vector3(-math.pi))
            assert.matches("<"..math.huge..",0,0>", cml.vector3(math.huge))
        end)

        it("with 2 numbers", function()
            assert.matches("<0,0,0>", cml.vector3(0, 0))
            assert.matches("<0,1,0>", cml.vector3(0, 1))
            assert.matches("<123,456,0>", cml.vector3(123, 456))
            assert.matches("<1.23,4.56,0>", cml.vector3(1.23, 4.56))
            assert.matches("<"..-math.pi..",1,0>", cml.vector3(-math.pi, 1))
            assert.matches("<"..math.huge..",1,0>", cml.vector3(math.huge, 1))
        end)

        it("with 3 numbers", function()
            assert.matches("<0,0,0>", cml.vector3(0, 0, 0))
            assert.matches("<0,1,2>", cml.vector3(0, 1, 2))
            assert.matches("<123,456,789>", cml.vector3(123, 456, 789))
            assert.matches("<1.23,4.56,7.89>", cml.vector3(1.23, 4.56, 7.89))
            assert.matches("<"..-math.pi..",1,2>", cml.vector3(-math.pi, 1, 2))
            assert.matches("<"..math.huge..",1,2>", cml.vector3(math.huge, 1, 2))
        end)

        it("with array of numbers", function()
            assert.matches("<0,0,0>", cml.vector3{0,0,0})
            assert.matches("<1,2,3>", cml.vector3{1,2,3})
            assert.matches("<1,2,0>", cml.vector3{1,2})
            assert.matches("<1,0,0>", cml.vector3{1})
            assert.matches("<0,0,0>", cml.vector3{})
        end)

        it("with vector4", function()
            assert.matches("<4,3,2>", cml.vector3(cml.vector4(4,3,2,1)))
            assert.matches("<1,2,3>", cml.vector3(cml.vector4(cml.vector3(1,2,3))))
        end)

        it("with vector3", function()
            assert.matches("<4,3,2>", cml.vector3(cml.vector3(4,3,2)))
            assert.matches("<1,2,3>", cml.vector3(cml.vector3(cml.vector3(1,2,3))))
        end)

        it("with vector2", function()
            assert.matches("<4,3,0>", cml.vector3(cml.vector2(4,3)))
            assert.matches("<1,2,0>", cml.vector3(cml.vector2(cml.vector3(1,2,3))))
        end)
    ...
    describe("newindex", function()
        it("with integer key", function()
            ...
            assert.matches("<0,0,0>", vec)
            vec[1] = 10
            assert.matches("<10,0,0>", vec)
            vec[2] = 20
            assert.matches("<10,20,0>", vec)
            vec[3] = 30
            assert.matches("<10,20,30>", vec)
        end)
